...
export class ChatParticipantsApi extends runtime.BaseAPI {
   ...
   */
  async chatParticipantsControllerAddParticipantToChatroomRaw(
    requestParameters: ChatParticipantsControllerAddParticipantToChatroomRequest,
    ...
    const response = await this.request(
      {
        path: `/chatParticipants/{chatRoomId}/join/{userId}`
          .replace(
            `{${"chatRoomId"}}`,
   ...
   * Add a participant to a chat room
   */
  async chatParticipantsControllerAddParticipantToChatroom(
    requestParameters: ChatParticipantsControllerAddParticipantToChatroomRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
    await this.chatParticipantsControllerAddParticipantToChatroomRaw(
      requestParameters,
      initOverrides,
    );
  }
   ...
   */
  async chatParticipantsControllerCreateRaw(
    requestParameters: ChatParticipantsControllerCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: CreateChatParticipantDtoToJSON(
          requestParameters["createChatParticipantDto"],
        ),
      },
      initOverrides,
    );
   ...
   * Create a chat participant
   */
  async chatParticipantsControllerCreate(
    requestParameters: ChatParticipantsControllerCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
    await this.chatParticipantsControllerCreateRaw(
      requestParameters,
      initOverrides,
    );
  }
   ...
   */
  async chatParticipantsControllerFindAllRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   * Fetch all chat participants
   */
  async chatParticipantsControllerFindAll(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
  ...
  async chatParticipantsControllerFindOneRaw(
    ...
    const response = await this.request(
      {
        path: `/chatParticipants/{id}`.replace(
          `{${"id"}}`,
  ...
  async chatParticipantsControllerFindOne(
    ...
    await this.chatParticipantsControllerFindOneRaw(
      requestParameters,
      initOverrides,
    );
  }
  ...
  async chatParticipantsControllerFindParticipantByChatRoomRaw(
    ...
    const response = await this.request(
      {
        path: `/chatParticipants/{chatRoomId}/find`.replace(
          `{${"chatRoomId"}}`,
          encodeURIComponent(String(requestParameters["chatRoomId"])),
        ),
        method: "GET",
  ...
  async chatParticipantsControllerFindParticipantChatRoomUserIdRaw(
    ...
    const response = await this.request(
      {
        path: `/chatParticipants/{chatRoomId}/find/{userId}`
          .replace(
            `{${"chatRoomId"}}`,
            encodeURIComponent(String(requestParameters["chatRoomId"])),
          )
   ...
   */
  async chatParticipantsControllerRemoveRaw(
    requestParameters: ChatParticipantsControllerRemoveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/chatParticipants/{chatRoomId}/delete/{id}`
          .replace(
            `{${"id"}}`,
            encodeURIComponent(String(requestParameters["id"])),
          )
   ...
   * Remove a chat participant
   */
  async chatParticipantsControllerRemove(
    requestParameters: ChatParticipantsControllerRemoveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
    await this.chatParticipantsControllerRemoveRaw(
      requestParameters,
      initOverrides,
    );
  }
  ...
  async chatParticipantsControllerUpdateParticipantRaw(
    ...
    const response = await this.request(
      {
        path: `/chatParticipants/{chatRoomId}/update/{id}`
          .replace(
            `{${"chatRoomId"}}`,
            encodeURIComponent(String(requestParameters["chatRoomId"])),
          )
        ...
        headers: headerParameters,
        query: queryParameters,
        body: UpdateChatParticipantDtoToJSON(
          requestParameters["updateChatParticipantDto"],
        ),
      },
      initOverrides,
    );
