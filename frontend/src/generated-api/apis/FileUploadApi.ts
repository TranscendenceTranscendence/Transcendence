...
import type { FileUploadResponseSuccess } from "../models/index";
import {
...
export class FileUploadApi extends runtime.BaseAPI {
  ...
  async fileUploadControllerUploadFileRaw(
  ...
  ): Promise<runtime.ApiResponse<FileUploadResponseSuccess>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      FileUploadResponseSuccessFromJSON(jsonValue),
    );
  }
  ...
  async fileUploadControllerUploadFile(
    requestParameters: FileUploadControllerUploadFileRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<FileUploadResponseSuccess> {
