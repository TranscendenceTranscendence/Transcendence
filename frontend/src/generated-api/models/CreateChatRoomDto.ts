...
export type CreateChatRoomDtoChatRoomTypeEnum =
  (typeof CreateChatRoomDtoChatRoomTypeEnum)[keyof typeof CreateChatRoomDtoChatRoomTypeEnum];
...
export type CreateChatRoomDtoRoleEnum =
  (typeof CreateChatRoomDtoRoleEnum)[keyof typeof CreateChatRoomDtoRoleEnum];

/**
 * Check if a given object implements the CreateChatRoomDto interface.
 */
export function instanceOfCreateChatRoomDto(
  value: object,
): value is CreateChatRoomDto {
...
export function CreateChatRoomDtoFromJSONTyped(
  json: any,
...
export function CreateChatRoomDtoToJSONTyped(
  value?: CreateChatRoomDto | null,
